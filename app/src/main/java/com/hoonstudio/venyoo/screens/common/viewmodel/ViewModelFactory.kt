...
import com.hoonstudio.venyoo.screens.AttractionViewModel
...
class ViewModelFactory @Inject constructor(
    ...
    private val attractionViewModelProvider: Provider<AttractionViewModel>,
    ...
    override fun <T : ViewModel?> create(key: String, modelClass: Class<T>, handle: SavedStateHandle): T {
        val viewModel = when(modelClass){
            ...
            AttractionViewModel::class.java -> attractionViewModelProvider.get() as T
